	...
	public void switchSocket(Socket newSocket) {
		...
		try {
			...
			synchronized (switchableOutputStream) {
				...
				numberOfBytesToRead = Integer.parseInt(message);
			...
			synchronized (switchableInputStream) {
				...
				System.out.println("trying to close oldSocket");
				oldSocket.close();
				switchableInputStream.setSwitchException(false);
			}
