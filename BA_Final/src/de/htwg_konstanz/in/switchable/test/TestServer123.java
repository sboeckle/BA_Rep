...
public class TestServer123 implements Runnable {
	
	static private SwitchableSocket switchableSocket;

	public static SwitchableSocket getSwitchableSocket() {
		return switchableSocket;
	}

	public static void setSwitchableSocket(SwitchableSocket switchableSocket) {
		TestServer123.switchableSocket = switchableSocket;
	}
