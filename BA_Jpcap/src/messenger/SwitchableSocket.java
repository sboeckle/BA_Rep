...
public class SwitchableSocket extends Socket {
	...
	public SwitchableSocket(Socket socket) throws IOException {
		this.socket = socket;
		switchableInputStream = new SwitchableInputStream(socket.getInputStream());
		switchableOutputStream = new SwitchableOutputStream(socket.getOutputStream());
	}


	public void switchSocket(Socket newSocket) throws IOException {
